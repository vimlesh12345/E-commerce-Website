  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto   my-2 mb-lg-0">
        ...
        <li class="<?php echo basename($_SERVER['PHP_SELF'])=='display_all.php'?'active':'';?>">
          ...
          <?php
                  if(!isset($_SESSION['username'])){
                    ...
                    echo "<li class='nav-item'>    
                    <a class='nav-link' href='./users_area/profile.php'><i class='fa-solid fa-id-card'></i>My Account</a>
                                        </li>";
                  }
                  ?>
        ...
        <li class="<?php echo basename($_SERVER['PHP_SELF'])=='cart_item(); '?'active':'';?>">
          <a class="nav-link" href="cart.php"><i class="fa-sharp fa-solid fa-cart-plus"></i> <sub>
           <?php cart_item(); ?></sub> Cart</a>
        </li>
        <li class="<?php echo basename($_SERVER['PHP_SELF'])=='total_cart_price();'?'active':'';?>">
...
<p class="text-center text-light" style="font-size:25px;font-weight:bold;">Delivary Brands</p>
        ...
        <ul class="navbar-nav me-auto text-center">
          <li class="nav-item bg-info">
            <a href="" class="nav-link text-light"></a><p class="text-center text-light" style="font-size:25px;font-weight:bold;">Categories</p>
          </li>
          <?php
        getcategories();
         ?>
